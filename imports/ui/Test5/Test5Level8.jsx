...
import  Test5Level8Graph  from '../Test4/Test4Level8Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test5Level8CorrectNumber = 0;
var Test5Level8WrongNumber = 0;
...
export default class Test5Level8 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test5[(this.state.test5.length)-1].Test5Level8CorrectNumber == null) {
			Test5Level8CorrectNumber = 0;
		} else {
			Test5Level8CorrectNumber = this.state.test5[(this.state.test5.length)-1].Test5Level8CorrectNumber;
		}
		if(this.state.test5[(this.state.test5.length)-1].Test5Level8WrongNumber == null) {
			Test5Level8WrongNumber = 0;
		} else {
			Test5Level8WrongNumber = this.state.test5[(this.state.test5.length)-1].Test5Level8WrongNumber;
		}
  		Test5Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test5TotalCorrect += 1;
    		Test5Level8WrongNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level8CorrectNumber == undefined) {
				Test5Level8CorrectNumber = 1;
			} else {
				console.log("here");
				Test5Level8CorrectNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level8CorrectNumber) +1;
			}

			if((Test5Level8CorrectNumber % 3) == 0) {
				incompleteLevel = 9;
				Meteor.call('test5.Test5Level8Insert',Test5Level8CorrectNumber, Test5Level8WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level9'), 0); //go forward here
			} else {
				incompleteLevel = 8;
				Meteor.call('test5.Test5Level8Insert',Test5Level8CorrectNumber, Test5Level8WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
    		...
    		Test5TotalWrong += 1;
    		Test5Level8CorrectNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level8WrongNumber == undefined) {
				Test5Level8WrongNumber = 1;
			} else {
				console.log("here");
				Test5Level8WrongNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level8WrongNumber) +1;
			}

			if((Test5Level8WrongNumber % 3) == 0) {
				incompleteLevel = 7;
				Meteor.call('test5.Test5Level8Insert',Test5Level8CorrectNumber, Test5Level8WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level7'), 0); //go back here
			} else {
				incompleteLevel = 8;
				Meteor.call('test5.Test5Level8Insert',Test5Level8CorrectNumber, Test5Level8WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test5[(this.state.test5.length)-1]) {
  			corno = this.state.test5[(this.state.test5.length)-1].Test5Level8CorrectNumber;
  			wrongno = this.state.test5[(this.state.test5.length)-1].Test5Level8WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test5Level8Graph array={this.state.graphArray}/>
						</div>
