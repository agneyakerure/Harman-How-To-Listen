...
import  Test5Level5Graph  from '../Test4/Test4Level5Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test5Level5CorrectNumber = 0;
var Test5Level5WrongNumber = 0;
...
export default class Test5Level5 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test5[(this.state.test5.length)-1].Test5Level5CorrectNumber == null) {
			Test5Level5CorrectNumber = 0;
		} else {
			Test5Level5CorrectNumber = this.state.test5[(this.state.test5.length)-1].Test5Level5CorrectNumber;
		}
		if(this.state.test5[(this.state.test5.length)-1].Test5Level5WrongNumber == null) {
			Test5Level5WrongNumber = 0;
		} else {
			Test5Level5WrongNumber = this.state.test5[(this.state.test5.length)-1].Test5Level5WrongNumber;
		}
  		Test5Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test5TotalCorrect += 1;
    		Test5Level5WrongNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level5CorrectNumber == undefined) {
				Test5Level5CorrectNumber = 1;
			} else {
				console.log("here");
				Test5Level5CorrectNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level5CorrectNumber) +1;
			}

			if((Test5Level5CorrectNumber % 3) == 0) {
				incompleteLevel = 6;
				Meteor.call('Test55.Test5Level5Insert',Test5Level5CorrectNumber, Test5Level5WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level6'), 0); //go forward here
			} else {
				incompleteLevel = 5;
				Meteor.call('test5.Test5Level5Insert',Test5Level5CorrectNumber, Test5Level5WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => window.location.reload(), 0);
			}
    	} else {
    		Test5TotalWrong += 1;
    		Test5Level5CorrectNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level5WrongNumber == undefined) {
				Test5Level5WrongNumber = 1;
			} else {
				console.log("here");
				Test5Level5WrongNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level5WrongNumber) +1;
			}

			if((Test5Level5WrongNumber % 3) == 0) {
				incompleteLevel = 4;
				Meteor.call('test5.Test5Level5Insert',Test5Level5CorrectNumber, Test5Level5WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level3'), 0); //go back here
			} else {
				incompleteLevel = 5;
				Meteor.call('test5.Test5Level5Insert',Test5Level5CorrectNumber, Test5Level5WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test5[(this.state.test5.length)-1]) {
  			corno = this.state.test5[(this.state.test5.length)-1].Test5Level5CorrectNumber;
  			wrongno = this.state.test5[(this.state.test5.length)-1].Test5Level5WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test5Level5Graph array={this.state.graphArray}/>
						</div>
