...
import  Test5Level6Graph  from '../Test4/Test4Level6Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test5Level6CorrectNumber = 0;
var Test5Level6WrongNumber = 0;
...
export default class Test5Level6 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test5[(this.state.test5.length)-1].Test5Level6CorrectNumber == null) {
			Test5Level6CorrectNumber = 0;
		} else {
			Test5Level6CorrectNumber = this.state.test5[(this.state.test5.length)-1].Test5Level6CorrectNumber;
		}
		if(this.state.test5[(this.state.test5.length)-1].Test5Level6WrongNumber == null) {
			Test5Level6WrongNumber = 0;
		} else {
			Test5Level6WrongNumber = this.state.test5[(this.state.test5.length)-1].Test5Level6WrongNumber;
		}
  		Test5Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test5TotalCorrect += 1;
    		Test5Level6WrongNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level6CorrectNumber == undefined) {
				Test5Level6CorrectNumber = 1;
			} else {
				console.log("here");
				Test5Level6CorrectNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level6CorrectNumber) +1;
			}

			if((Test5Level6CorrectNumber % 3) == 0) {
				incompleteLevel = 7;
				Meteor.call('test5.Test5Level6Insert',Test5Level6CorrectNumber, Test5Level6WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level7'), 0); //go forward here
			} else {
				incompleteLevel = 6;
				Meteor.call('test5.Test5Level6Insert',Test5Level6CorrectNumber, Test5Level6WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
    		...
    		Test5TotalWrong += 1;
    		Test5Level6CorrectNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level6WrongNumber == undefined) {
				Test5Level6WrongNumber = 1;
			} else {
				console.log("here");
				Test5Level6WrongNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level6WrongNumber) +1;
			}

			if((Test5Level6WrongNumber % 3) == 0) {
				incompleteLevel = 5;
				Meteor.call('test5.Test5Level6Insert',Test5Level6CorrectNumber, Test5Level6WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level5'), 0); //go back here
			} else {
				incompleteLevel = 6;
				Meteor.call('test5.Test5Level6Insert',Test5Level6CorrectNumber, Test5Level6WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test5[(this.state.test5.length)-1]) {
  			corno = this.state.test5[(this.state.test5.length)-1].Test5Level6CorrectNumber;
  			wrongno = this.state.test5[(this.state.test5.length)-1].Test5Level6WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test5Level6Graph array={this.state.graphArray}/>
						</div>
