...
// import  Test5Level0Graph  from './Test5Level0Graph.jsx';
...
export default class Test5Level0 extends Component {
	...
	onModalOk = (event) => {
		...
		//this.stop();
		Meteor.call('test5.Test5Level0Insert',0, 1);
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test5Level0Graph array={this.props.newArray}/>
						</div>
...
class Test5Level0Graph extends Component {
...
biquadFilter.type = "highpass"; //most important - can be highpass, lowpass, peaking, notch
...
biquadFilter2.type = "highpass"; //most important - can be highpass, lowpass, peaking, notch
		...
		return (
			<div className = "chart">
				<div className = "chart__content">
					<h1 className = "chart__header">Highpass - Instroduction</h1>
