...
import  Test5Level9Graph  from '../Test4/Test4Level9Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test5Level9CorrectNumber = 0;
var Test5Level9WrongNumber = 0;
...
export default class Test5Level9 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test5[(this.state.test5.length)-1].Test5Level9CorrectNumber == null) {
			Test5Level9CorrectNumber = 0;
		} else {
			Test5Level9CorrectNumber = this.state.test5[(this.state.test5.length)-1].Test5Level9CorrectNumber;
		}
		if(this.state.test5[(this.state.test5.length)-1].Test5Level9WrongNumber == null) {
			Test5Level9WrongNumber = 0;
		} else {
			Test5Level9WrongNumber = this.state.test5[(this.state.test5.length)-1].Test5Level9WrongNumber;
		}
  		Test5Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test5TotalCorrect += 1;
    		Test5Level9WrongNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level9CorrectNumber == undefined) {
				Test5Level9CorrectNumber = 1;
			} else {
				console.log("here");
				Test5Level9CorrectNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level9CorrectNumber) +1;
			}

			if((Test5Level9CorrectNumber % 3) == 0) {
				incompleteLevel = 10;
				Meteor.call('test5.Test5Level9Insert',Test5Level9CorrectNumber, Test5Level9WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level10'), 0); //go forward here
			} else {
				incompleteLevel = 9;
				Meteor.call('test5.Test5Level9Insert',Test5Level9CorrectNumber, Test5Level9WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
    		...
    		Test5TotalWrong += 1;
    		Test5Level9CorrectNumber = 0;
    		if(this.state.test5[(this.state.test5.length)-1].Test5Level9WrongNumber == undefined) {
				Test5Level9WrongNumber = 1;
			} else {
				console.log("here");
				Test5Level9WrongNumber=(this.state.test5[(this.state.test5.length)-1].Test5Level9WrongNumber) +1;
			}

			if((Test5Level9WrongNumber % 3) == 0) {
				incompleteLevel = 8;
				Meteor.call('test5.Test5Level9Insert',Test5Level9CorrectNumber, Test5Level9WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => history.push('/Test5Level8'), 0); //go back here
			} else {
				incompleteLevel = 9;
				Meteor.call('test5.Test5Level9Insert',Test5Level9CorrectNumber, Test5Level9WrongNumber, incompleteLevel, Test5Attempts, Test5TotalCorrect, Test5TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test5[(this.state.test5.length)-1]) {
  			corno = this.state.test5[(this.state.test5.length)-1].Test5Level9CorrectNumber;
  			wrongno = this.state.test5[(this.state.test5.length)-1].Test5Level9WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test5Level9Graph array={this.state.graphArray}/>
						</div>
