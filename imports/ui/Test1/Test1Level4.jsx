...
export default class Test1Level4 extends Component {
	...
	onSubmit(e) {
	    ...
	    if(_.isEqual(check, answer)) {
			...
			if((this.state.values[(this.state.values.length)-1].Test1Level4CorrectNumber%4)==2) {
			...
			if((this.state.values[(this.state.values.length)-1].Test1Level4WrongNumber%4)==2) {
