...
import  Test3Level8Graph  from './Test3Level8Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test3Level8CorrectNumber = 0;
var Test3Level8WrongNumber = 0;
...
export default class Test3Level8 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test3[(this.state.test3.length)-1].Test3Level8CorrectNumber == null) {
			Test3Level8CorrectNumber = 0;
		} else {
			Test3Level8CorrectNumber = this.state.test3[(this.state.test3.length)-1].Test3Level8CorrectNumber;
		}
		if(this.state.test3[(this.state.test3.length)-1].Test3Level8WrongNumber == null) {
			Test3Level8WrongNumber = 0;
		} else {
			Test3Level8WrongNumber = this.state.test3[(this.state.test3.length)-1].Test3Level8WrongNumber;
		}
  		Test3Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test3TotalCorrect += 1;
    		Test3Level8WrongNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level8CorrectNumber == undefined) {
				Test3Level8CorrectNumber = 1;
			} else {
				console.log("here");
				Test3Level8CorrectNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level8CorrectNumber) +1;
			}

			if((Test3Level8CorrectNumber % 3) == 0) {
				incompleteLevel = 9;
				Meteor.call('test3.Test3Level8Insert',Test3Level8CorrectNumber, Test3Level8WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level9'), 0); //go forward here
			} else {
				incompleteLevel = 8;
				Meteor.call('test3.Test3Level8Insert',Test3Level8CorrectNumber, Test3Level8WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
    		...
    		Test3TotalWrong += 1;
    		Test3Level8CorrectNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level8WrongNumber == undefined) {
				Test3Level8WrongNumber = 1;
			} else {
				console.log("here");
				Test3Level8WrongNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level8WrongNumber) +1;
			}

			if((Test3Level8WrongNumber % 3) == 0) {
				incompleteLevel = 7;
				Meteor.call('test3.Test3Level8Insert',Test3Level8CorrectNumber, Test3Level8WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level7'), 0); //go back here
			} else {
				incompleteLevel = 8;
				Meteor.call('test3.Test3Level8Insert',Test3Level8CorrectNumber, Test3Level8WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test3[(this.state.test3.length)-1]) {
  			corno = this.state.test3[(this.state.test3.length)-1].Test3Level8CorrectNumber;
  			wrongno = this.state.test3[(this.state.test3.length)-1].Test3Level8WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
  		return(
			<div>
				<PrivateHeader title="Level8"/>
				<div>
					<div>
						<div className = "chartBox">
							<Test3Level8Graph array={this.state.graphArray}/>
						</div>
