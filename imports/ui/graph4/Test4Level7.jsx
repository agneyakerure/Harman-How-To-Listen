...
import  Test3Level7Graph  from './Test3Level7Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test3Level7CorrectNumber = 0;
var Test3Level7WrongNumber = 0;
...
export default class Test3Level7 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test3[(this.state.test3.length)-1].Test3Level7CorrectNumber == null) {
			Test3Level7CorrectNumber = 0;
		} else {
			Test3Level7CorrectNumber = this.state.test3[(this.state.test3.length)-1].Test3Level7CorrectNumber;
		}
		if(this.state.test3[(this.state.test3.length)-1].Test3Level7WrongNumber == null) {
			Test3Level7WrongNumber = 0;
		} else {
			Test3Level7WrongNumber = this.state.test3[(this.state.test3.length)-1].Test3Level7WrongNumber;
		}
  		Test3Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test3TotalCorrect += 1;
    		Test3Level7WrongNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level7CorrectNumber == undefined) {
				Test3Level7CorrectNumber = 1;
			} else {
				console.log("here");
				Test3Level7CorrectNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level7CorrectNumber) +1;
			}

			if((Test3Level7CorrectNumber % 3) == 0) {
				incompleteLevel = 8;
				Meteor.call('test3.Test3Level7Insert',Test3Level7CorrectNumber, Test3Level7WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level8'), 0); //go forward here
			} else {
				incompleteLevel = 7;
				Meteor.call('test3.Test3Level7Insert',Test3Level7CorrectNumber, Test3Level7WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
    		...
    		Test3TotalWrong += 1;
    		Test3Level7CorrectNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level7WrongNumber == undefined) {
				Test3Level7WrongNumber = 1;
			} else {
				console.log("here");
				Test3Level7WrongNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level7WrongNumber) +1;
			}

			if((Test3Level7WrongNumber % 3) == 0) {
				incompleteLevel = 6;
				Meteor.call('test3.Test3Level7Insert',Test3Level7CorrectNumber, Test3Level7WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level6'), 0); //go back here
			} else {
				incompleteLevel = 7;
				Meteor.call('test3.Test3Level7Insert',Test3Level7CorrectNumber, Test3Level7WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test3[(this.state.test3.length)-1]) {
  			corno = this.state.test3[(this.state.test3.length)-1].Test3Level7CorrectNumber;
  			wrongno = this.state.test3[(this.state.test3.length)-1].Test3Level7WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test3Level7Graph array={this.state.graphArray}/>
						</div>
