...
export default class Test4Level1Graph extends Component {
	...
	componentDidMount() {
		...
		biquadFilter.frequency.value = 8000; //most important - change this to see if filter working properly - it is
		...
		biquadFilter3.frequency.value = 500; //most important - change this to see if filter working properly - it is
		...
		for (var i=0; i < peaks.length; i++) {
		    ...
		    focus.append("text").text(Math.round(100*f)/100+" Hz, "+Math.round(100*a)/100+" dB") //label
		    	.attr("x", x(f)-30)
		    	.attr("y", ydb(a)-7)
