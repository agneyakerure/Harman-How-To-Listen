...
import  Test3Level9Graph  from './Test3Level9Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test3Level9CorrectNumber = 0;
var Test3Level9WrongNumber = 0;
var incompleteLevel = 9;
var Test3Attempts = 0;
...
export default class Test3Level9 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test3[(this.state.test3.length)-1].Test3Level9CorrectNumber == null) {
			Test3Level9CorrectNumber = 0;
		} else {
			Test3Level9CorrectNumber = this.state.test3[(this.state.test3.length)-1].Test3Level9CorrectNumber;
		}
		if(this.state.test3[(this.state.test3.length)-1].Test3Level9WrongNumber == null) {
			Test3Level9WrongNumber = 0;
		} else {
			Test3Level9WrongNumber = this.state.test3[(this.state.test3.length)-1].Test3Level9WrongNumber;
		}
  		Test3Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test3TotalCorrect += 1;
    		Test3Level9WrongNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level9CorrectNumber == undefined) {
				Test3Level9CorrectNumber = 1;
			} else {
				console.log("here");
				Test3Level9CorrectNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level9CorrectNumber) +1;
			}

			if((Test3Level9CorrectNumber % 3) == 0) {
				incompleteLevel = 10;
				Meteor.call('test3.Test3Level9Insert',Test3Level9CorrectNumber, Test3Level9WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level10'), 0); //go forward here
			} else {
				incompleteLevel = 9;
				Meteor.call('test3.Test3Level9Insert',Test3Level9CorrectNumber, Test3Level9WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
    		...
    		Test3TotalWrong += 1;
    		Test3Level9CorrectNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level9WrongNumber == undefined) {
				Test3Level9WrongNumber = 1;
			} else {
				console.log("here");
				Test3Level9WrongNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level9WrongNumber) +1;
			}

			if((Test3Level9WrongNumber % 3) == 0) {
				incompleteLevel = 8;
				Meteor.call('test3.Test3Level9Insert',Test3Level9CorrectNumber, Test3Level9WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
  	...
  	render() {
  		...
  		if(this.state.test3[(this.state.test3.length)-1]) {
  			corno = this.state.test3[(this.state.test3.length)-1].Test3Level9CorrectNumber;
  			wrongno = this.state.test3[(this.state.test3.length)-1].Test3Level9WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
  		return(
			<div>
				<PrivateHeader title="Level9"/>
				<div>
					<div>
						<div className = "chartBox">
							<Test3Level9Graph array={this.state.graphArray}/>
						</div>
