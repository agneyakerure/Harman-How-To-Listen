...
export default class Test3Level1Graph extends Component {
	...
	componentDidMount() {
		...
		// biquadFilter3.Q.value = this.props.array[2];
		...
		// biquadFilter4.type = this.props.array[].type; //most important - can be highpass, lowpass, peaking, notch
