...
import  Test3Level5Graph  from './Test3Level5Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test3Level5CorrectNumber = 0;
var Test3Level5WrongNumber = 0;
...
export default class Test3Level5 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test3[(this.state.test3.length)-1].Test3Level5CorrectNumber == null) {
			Test3Level5CorrectNumber = 0;
		} else {
			Test3Level5CorrectNumber = this.state.test3[(this.state.test3.length)-1].Test3Level5CorrectNumber;
		}
		if(this.state.test3[(this.state.test3.length)-1].Test3Level5WrongNumber == null) {
			Test3Level5WrongNumber = 0;
		} else {
			Test3Level5WrongNumber = this.state.test3[(this.state.test3.length)-1].Test3Level5WrongNumber;
		}
  		Test3Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test3TotalCorrect += 1;
    		Test3Level5WrongNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level5CorrectNumber == undefined) {
				Test3Level5CorrectNumber = 1;
			} else {
				console.log("here");
				Test3Level5CorrectNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level5CorrectNumber) +1;
			}

			if((Test3Level5CorrectNumber % 3) == 0) {
				incompleteLevel = 6;
				Meteor.call('test3.Test3Level5Insert',Test3Level5CorrectNumber, Test3Level5WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level6'), 0); //go forward here
			} else {
				incompleteLevel = 5;
				Meteor.call('test3.Test3Level5Insert',Test3Level5CorrectNumber, Test3Level5WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
    		...
    		Test3TotalWrong += 1;
    		Test3Level5CorrectNumber = 0;
    		if(this.state.test3[(this.state.test3.length)-1].Test3Level5WrongNumber == undefined) {
				Test3Level5WrongNumber = 1;
			} else {
				console.log("here");
				Test3Level5WrongNumber=(this.state.test3[(this.state.test3.length)-1].Test3Level5WrongNumber) +1;
			}

			if((Test3Level5WrongNumber % 3) == 0) {
				incompleteLevel = 4;
				Meteor.call('test3.Test3Level5Insert',Test3Level5CorrectNumber, Test3Level5WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => history.push('/Test3Level4'), 0); //go back here
			} else {
				incompleteLevel = 5;
				Meteor.call('test3.Test3Level5Insert',Test3Level5CorrectNumber, Test3Level5WrongNumber, incompleteLevel, Test3Attempts, Test3TotalCorrect, Test3TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test3[(this.state.test3.length)-1]) {
  			corno = this.state.test3[(this.state.test3.length)-1].Test3Level5CorrectNumber;
  			wrongno = this.state.test3[(this.state.test3.length)-1].Test3Level5WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test3Level5Graph array={this.state.graphArray}/>
						</div>
