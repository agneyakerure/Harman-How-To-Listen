...
export default class Test4Level9Graph extends Component {
...
biquadFilter9.frequency.value, biquadFilter10.frequency.value]; 
...
var width = 800; 
	...
	var getIndex= d3.bisector(function(d){return d.x}).left;
	    ...
	    var magResponse = [magResponse1, magResponse2, magResponse3, magResponse4, magResponse5, magResponse6, magResponse7, magResponse8, magResponse9, magResponse10];
