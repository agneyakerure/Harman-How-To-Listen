...
//Level Variables
var Test4Level4CorrectNumber = 0;
var Test4Level4WrongNumber = 0;
...
export default class Test4Level4 extends Component {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level4CorrectNumber == null) {
			Test4Level4CorrectNumber = 0;
		} else {
			Test4Level4CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level4CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level4WrongNumber == null) {
			Test4Level4WrongNumber = 0;
		} else {
			Test4Level4WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level4WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level4WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level4CorrectNumber == undefined) {
				Test4Level4CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level4CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level4CorrectNumber) +1;
			}

			if((Test4Level4CorrectNumber % 3) == 0) {
				incompleteLevel = 5;
				Meteor.call('test4.Test4Level4Insert',Test4Level4CorrectNumber, Test4Level4WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level5'), 0); //go forward here
			} else {
				incompleteLevel = 4;
				Meteor.call('test4.Test4Level4Insert',Test4Level4CorrectNumber, Test4Level4WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level4CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level4WrongNumber == undefined) {
				Test4Level4WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level4WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level4WrongNumber) +1;
			}

			if((Test4Level4WrongNumber % 3) == 0) {
				incompleteLevel = 3;
				Meteor.call('test4.Test4Level4Insert',Test4Level4CorrectNumber, Test4Level4WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level4CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level4WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
