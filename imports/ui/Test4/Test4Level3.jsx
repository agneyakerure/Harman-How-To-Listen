...
import  Test4Level3Graph  from './Test4Level3Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level3CorrectNumber = 0;
var Test4Level3WrongNumber = 0;
...
export default class Test4Level3 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level3CorrectNumber == null) {
			Test4Level3CorrectNumber = 0;
		} else {
			Test4Level3CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level3CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level3WrongNumber == null) {
			Test4Level3WrongNumber = 0;
		} else {
			Test4Level3WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level3WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level3WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level3CorrectNumber == undefined) {
				Test4Level3CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level3CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level3CorrectNumber) +1;
			}

			if((Test4Level3CorrectNumber % 3) == 0) {
				incompleteLevel = 4;
				Meteor.call('test4.Test4Level3Insert',Test4Level3CorrectNumber, Test4Level3WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level4'), 0); //go forward here
			} else {
				incompleteLevel = 3;
				Meteor.call('test4.Test4Level3Insert',Test4Level3CorrectNumber, Test4Level3WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level3CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level3WrongNumber == undefined) {
				Test4Level3WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level3WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level3WrongNumber) +1;
			}

			if((Test4Level3WrongNumber % 3) == 0) {
				incompleteLevel = 2;
				Meteor.call('test4.Test4Level3Insert',Test4Level3CorrectNumber, Test4Level3WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level2'), 0); //go back here
			} else {
				incompleteLevel = 3;
				Meteor.call('test4.Test4Level3Insert',Test4Level3CorrectNumber, Test4Level3WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level3CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level3WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level3Graph array={this.state.graphArray}/>
						</div>
