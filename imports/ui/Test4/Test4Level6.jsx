...
import  Test4Level6Graph  from './Test4Level6Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level6CorrectNumber = 0;
var Test4Level6WrongNumber = 0;
...
export default class Test4Level6 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level6CorrectNumber == null) {
			Test4Level6CorrectNumber = 0;
		} else {
			Test4Level6CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level6CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level6WrongNumber == null) {
			Test4Level6WrongNumber = 0;
		} else {
			Test4Level6WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level6WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level6WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level6CorrectNumber == undefined) {
				Test4Level6CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level6CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level6CorrectNumber) +1;
			}

			if((Test4Level6CorrectNumber % 3) == 0) {
				incompleteLevel = 7;
				Meteor.call('test4.Test4Level6Insert',Test4Level6CorrectNumber, Test4Level6WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level7'), 0); //go forward here
			} else {
				incompleteLevel = 6;
				Meteor.call('test4.Test4Level6Insert',Test4Level6CorrectNumber, Test4Level6WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level6CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level6WrongNumber == undefined) {
				Test4Level6WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level6WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level6WrongNumber) +1;
			}

			if((Test4Level6WrongNumber % 3) == 0) {
				incompleteLevel = 5;
				Meteor.call('test4.Test4Level6Insert',Test4Level6CorrectNumber, Test4Level6WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level5'), 0); //go back here
			} else {
				incompleteLevel = 6;
				Meteor.call('test4.Test4Level6Insert',Test4Level6CorrectNumber, Test4Level6WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level6CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level6WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level6Graph array={this.state.graphArray}/>
						</div>
