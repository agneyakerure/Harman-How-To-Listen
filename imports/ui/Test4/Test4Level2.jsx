...
import  Test4Level2Graph  from './Test4Level2Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level2CorrectNumber = 0;
var Test4Level2WrongNumber = 0;
...
export default class Test4Level2 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level2CorrectNumber == null) {
			Test4Level2CorrectNumber = 0;
		} else {
			Test4Level2CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level2CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level2WrongNumber == null) {
			Test4Level2WrongNumber = 0;
		} else {
			Test4Level2WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level2WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level2WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level2CorrectNumber == undefined) {
				Test4Level2CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level2CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level2CorrectNumber) +1;
			}

			if((Test4Level2CorrectNumber % 3) == 0) {
				incompleteLevel = 3;
				Meteor.call('test4.Test4Level2Insert',Test4Level2CorrectNumber, Test4Level2WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level3'), 0); //go forward here
			} else {
				incompleteLevel = 2;
				Meteor.call('test4.Test4Level2Insert',Test4Level2CorrectNumber, Test4Level2WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level2CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level2WrongNumber == undefined) {
				Test4Level2WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level2WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level2WrongNumber) +1;
			}

			if((Test4Level2WrongNumber % 3) == 0) {
				incompleteLevel = 1;
				Meteor.call('test4.Test4Level2Insert',Test4Level2CorrectNumber, Test4Level2WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level1'), 0); //go back here
			} else {
				incompleteLevel = 2;
				Meteor.call('test4.Test4Level2Insert',Test4Level2CorrectNumber, Test4Level2WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level2CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level2WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level2Graph array={this.state.graphArray}/>
						</div>
