...
import  Test4Level10Graph  from './Test4Level10Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level10CorrectNumber = 0;
var Test4Level10WrongNumber = 0;
...
export default class Test4Level10 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level10CorrectNumber == null) {
			Test4Level10CorrectNumber = 0;
		} else {
			Test4Level10CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level10CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level10WrongNumber == null) {
			Test4Level10WrongNumber = 0;
		} else {
			Test4Level10WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level10WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level10WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level10CorrectNumber == undefined) {
				Test4Level10CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level10CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level10CorrectNumber) +1;
			}

			if((Test4Level10CorrectNumber % 3) == 0) {
				incompleteLevel = 0;
				Meteor.call('test4.Test4Level10Insert',Test4Level10CorrectNumber, Test4Level10WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level0'), 0); //go forward here
			} else {
				incompleteLevel = 10;
				Meteor.call('test4.Test4Level10Insert',Test4Level10CorrectNumber, Test4Level10WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level10CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level10WrongNumber == undefined) {
				Test4Level10WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level10WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level10WrongNumber) +1;
			}

			if((Test4Level10WrongNumber % 3) == 0) {
				incompleteLevel = 9;
				Meteor.call('test4.Test4Level10Insert',Test4Level10CorrectNumber, Test4Level10WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level9'), 0); //go back here
			} else {
				incompleteLevel = 10;
				Meteor.call('test4.Test4Level10Insert',Test4Level10CorrectNumber, Test4Level10WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level10CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level10WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level10Graph array={this.state.graphArray}/>
						</div>
