...
export default class Test4Level7Graph extends Component {
...
var peaks = [biquadFilter.frequency.value, biquadFilter2.frequency.value, biquadFilter3.frequency.value,
 biquadFilter4.frequency.value, biquadFilter5.frequency.value, biquadFilter6.frequency.value, biquadFilter7.frequency.value, 
 biquadFilter8.frequency.value]; 
...
var width = 800; 
	...
	var getIndex= d3.bisector(function(d){return d.x}).left;
	    ...
	    var magResponse = [magResponse1, magResponse2, magResponse3, magResponse4, magResponse5, magResponse6, magResponse7, magResponse8];
