...
import  Test4Level5Graph  from './Test4Level5Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level5CorrectNumber = 0;
var Test4Level5WrongNumber = 0;
...
export default class Test4Level5 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level5CorrectNumber == null) {
			Test4Level5CorrectNumber = 0;
		} else {
			Test4Level5CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level5CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level5WrongNumber == null) {
			Test4Level5WrongNumber = 0;
		} else {
			Test4Level5WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level5WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level5WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level5CorrectNumber == undefined) {
				Test4Level5CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level5CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level5CorrectNumber) +1;
			}

			if((Test4Level5CorrectNumber % 3) == 0) {
				incompleteLevel = 6;
				Meteor.call('test4.Test4Level5Insert',Test4Level5CorrectNumber, Test4Level5WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level6'), 0); //go forward here
			} else {
				incompleteLevel = 5;
				Meteor.call('test4.Test4Level5Insert',Test4Level5CorrectNumber, Test4Level5WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level5CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level5WrongNumber == undefined) {
				Test4Level5WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level5WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level5WrongNumber) +1;
			}

			if((Test4Level5WrongNumber % 3) == 0) {
				incompleteLevel = 4;
				Meteor.call('test4.Test4Level5Insert',Test4Level5CorrectNumber, Test4Level5WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level4'), 0); //go back here
			} else {
				incompleteLevel = 5;
				Meteor.call('test4.Test4Level5Insert',Test4Level5CorrectNumber, Test4Level5WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level5CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level5WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level5Graph array={this.state.graphArray}/>
						</div>
