...
// import  Test4Level0Graph  from './Test4Level0Graph.jsx';
...
export default class Test4Level0 extends Component {
	constructor(props) {
		super(props);
		this.state = {
			isOpen: false,
	...
	onModalOk = (event) => {
		...
		//this.stop();
		Meteor.call('test4.Test4Level0Insert',0, 1);
				setTimeout(() => history.push('/Test4Level1'), 0);
	}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level0Graph array={this.props.newArray}/>
						</div>
...
class Test4Level0Graph extends Component {
...
biquadFilter.type = "lowpass"; //most important - can be highpass, lowpass, peaking, notch
biquadFilter.frequency.value = 100; //most important - change this to see if filter working properly - it is
biquadFilter.Q.value = -1;
biquadFilter.gain.value = 3; // gain should be 6 when used in peaking/notch
biquadFilter.connect(audioContext.destination);

//filter properties - play with this to set filter
biquadFilter2 = audioContext.createBiquadFilter(); 
biquadFilter2.type = "lowpass"; //most important - can be highpass, lowpass, peaking, notch
...
biquadFilter2.gain.value = 3; // gain should be 6 when used in peaking/notch
biquadFilter2.connect(audioContext.destination);

//filter properties - play with this to set filter
// biquadFilter3 = audioContext.createBiquadFilter(); 
// biquadFilter3.type = "lowpass"; //most important - can be highpass, lowpass, peaking, notch
...
var width = 800; 
	...
	var getIndex= d3.bisector(function(d){return d.x}).left;
	    ...
	    var magResponse = [magResponse1, magResponse2];
		...
		return (
			<div className = "chart">
				<div className = "chart__content">
					<h1 className = "chart__header">Lowpass - Instroduction</h1>
