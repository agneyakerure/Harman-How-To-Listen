...
import  Test4Level7Graph  from './Test4Level7Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level7CorrectNumber = 0;
var Test4Level7WrongNumber = 0;
...
export default class Test4Level7 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level7CorrectNumber == null) {
			Test4Level7CorrectNumber = 0;
		} else {
			Test4Level7CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level7CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level7WrongNumber == null) {
			Test4Level7WrongNumber = 0;
		} else {
			Test4Level7WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level7WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level7WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level7CorrectNumber == undefined) {
				Test4Level7CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level7CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level7CorrectNumber) +1;
			}

			if((Test4Level7CorrectNumber % 3) == 0) {
				incompleteLevel = 8;
				Meteor.call('test4.Test4Level7Insert',Test4Level7CorrectNumber, Test4Level7WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level8'), 0); //go forward here
			} else {
				incompleteLevel = 7;
				Meteor.call('test4.Test4Level7Insert',Test4Level7CorrectNumber, Test4Level7WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level7CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level7WrongNumber == undefined) {
				Test4Level7WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level7WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level7WrongNumber) +1;
			}

			if((Test4Level7WrongNumber % 3) == 0) {
				incompleteLevel = 6;
				Meteor.call('test4.Test4Level7Insert',Test4Level7CorrectNumber, Test4Level7WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level6'), 0); //go back here
			} else {
				incompleteLevel = 7;
				Meteor.call('test4.Test4Level7Insert',Test4Level7CorrectNumber, Test4Level7WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level7CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level7WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level7Graph array={this.state.graphArray}/>
						</div>
