...
import  Test4Level9Graph  from './Test4Level9Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test4Level9CorrectNumber = 0;
var Test4Level9WrongNumber = 0;
...
export default class Test4Level9 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test4[(this.state.test4.length)-1].Test4Level9CorrectNumber == null) {
			Test4Level9CorrectNumber = 0;
		} else {
			Test4Level9CorrectNumber = this.state.test4[(this.state.test4.length)-1].Test4Level9CorrectNumber;
		}
		if(this.state.test4[(this.state.test4.length)-1].Test4Level9WrongNumber == null) {
			Test4Level9WrongNumber = 0;
		} else {
			Test4Level9WrongNumber = this.state.test4[(this.state.test4.length)-1].Test4Level9WrongNumber;
		}
  		Test4Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test4TotalCorrect += 1;
    		Test4Level9WrongNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level9CorrectNumber == undefined) {
				Test4Level9CorrectNumber = 1;
			} else {
				console.log("here");
				Test4Level9CorrectNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level9CorrectNumber) +1;
			}

			if((Test4Level9CorrectNumber % 3) == 0) {
				incompleteLevel = 10;
				Meteor.call('test4.Test4Level9Insert',Test4Level9CorrectNumber, Test4Level9WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level10'), 0); //go forward here
			} else {
				incompleteLevel = 9;
				Meteor.call('test4.Test4Level9Insert',Test4Level9CorrectNumber, Test4Level9WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
    		...
    		Test4TotalWrong += 1;
    		Test4Level9CorrectNumber = 0;
    		if(this.state.test4[(this.state.test4.length)-1].Test4Level9WrongNumber == undefined) {
				Test4Level9WrongNumber = 1;
			} else {
				console.log("here");
				Test4Level9WrongNumber=(this.state.test4[(this.state.test4.length)-1].Test4Level9WrongNumber) +1;
			}

			if((Test4Level9WrongNumber % 3) == 0) {
				incompleteLevel = 8;
				Meteor.call('test4.Test4Level9Insert',Test4Level9CorrectNumber, Test4Level9WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => history.push('/Test4Level8'), 0); //go back here
			} else {
				incompleteLevel = 9;
				Meteor.call('test4.Test4Level9Insert',Test4Level9CorrectNumber, Test4Level9WrongNumber, incompleteLevel, Test4Attempts, Test4TotalCorrect, Test4TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test4[(this.state.test4.length)-1]) {
  			corno = this.state.test4[(this.state.test4.length)-1].Test4Level9CorrectNumber;
  			wrongno = this.state.test4[(this.state.test4.length)-1].Test4Level9WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test4Level9Graph array={this.state.graphArray}/>
						</div>
