...
export default class Dashboard extends Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			Test5Link: Test5Links[0],
			//Test6Link: Test6Links[0],
    	...
    	return (
        	<div>
        		...
        		<div className = "page-content">
        			<div>
	        			<h1>Band ID Training</h1>
	        		</div>

	          		<div className = "item">
	          			<Link className = "button button--pill" to={this.state.Test2Link}>Peaks</Link> 
	          		...
	          		<div className = "item">
	          			<Link className = "button button--pill" to={this.state.Test3Link}>Dips</Link> 
	          		...
	          		<div className = "item">
	          			<Link className = "button button--pill" to={this.state.Test4Link}>Lowpass</Link> 
	          		...
	          		<div className = "item">
	          			<Link className = "button button--pill" to={this.state.Test5Link}>Highpass</Link> 
