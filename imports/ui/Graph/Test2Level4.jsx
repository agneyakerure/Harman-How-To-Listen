...
import  Test2Level4Graph  from './Test2Level4Graph.jsx';
...
export default class Test2Level4 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test2[(this.state.test2.length)-1].Test2Level4CorrectNumber == null) {
			Test2Level4CorrectNumber = 0;
		} else {
			Test2Level4CorrectNumber = this.state.test2[(this.state.test2.length)-1].Test2Level4CorrectNumber;
		}
		if(this.state.test2[(this.state.test2.length)-1].Test2Level4WrongNumber == null) {
			Test2Level4WrongNumber = 0;
		} else {
			Test2Level4WrongNumber = this.state.test2[(this.state.test2.length)-1].Test2Level4WrongNumber;
		}
  		Test2Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test2TotalCorrect += 1;
    		Test2Level4WrongNumber = 0;
    		if(this.state.test2[(this.state.test2.length)-1].Test2Level4CorrectNumber == undefined) {
				Test2Level4CorrectNumber = 1;
			} else {
				console.log("here");
				Test2Level4CorrectNumber=(this.state.test2[(this.state.test2.length)-1].Test2Level4CorrectNumber) +1;
			}

			if((Test2Level4CorrectNumber % 3) == 0) {
				incompleteLevel = 5;
				Meteor.call('test2.Test2Level4Insert',Test2Level4CorrectNumber, Test2Level4WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
				setTimeout(() => history.push('/Test2Level5'), 0); //go forward here
			} else {
				incompleteLevel = 4;
				Meteor.call('test2.Test2Level4Insert',Test2Level4CorrectNumber, Test2Level4WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
    		...
    		Test2TotalWrong += 1;
    		Test2Level4CorrectNumber = 0;
    		if(this.state.test2[(this.state.test2.length)-1].Test2Level4WrongNumber == undefined) {
				Test2Level4WrongNumber = 1;
			} else {
				console.log("here");
				Test2Level4WrongNumber=(this.state.test2[(this.state.test2.length)-1].Test2Level4WrongNumber) +1;
			}

			if((Test2Level4WrongNumber % 3) == 0) {
				incompleteLevel = 3;
				Meteor.call('test2.Test2Level4Insert',Test2Level4CorrectNumber, Test2Level4WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
				setTimeout(() => history.push('/Test2Level3'), 0); //go back here
			} else {
				incompleteLevel = 4;
				Meteor.call('test2.Test2Level4Insert',Test2Level4CorrectNumber, Test2Level4WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
				setTimeout(() => window.location.reload(), 0);
