...
import  Test2Level8Graph  from './Test2Level8Graph.jsx';
import Modal from 'react-modal';
//For React Router
const history = createBrowserHistory({forceRefresh: true});

//Level Variables
var Test2Level8CorrectNumber = 0;
var Test2Level8WrongNumber = 0;
...
export default class Test2Level8 extends Component {
	constructor(props) {
		super(props);
		this.state = {
	...
	correct = (event) => {
  	...
  	onModalOk = (event) => {
		...
		if(this.state.test2[(this.state.test2.length)-1].Test2Level8CorrectNumber == null) {
			Test2Level8CorrectNumber = 0;
		} else {
			Test2Level8CorrectNumber = this.state.test2[(this.state.test2.length)-1].Test2Level8CorrectNumber;
		}
		if(this.state.test2[(this.state.test2.length)-1].Test2Level8WrongNumber == null) {
			Test2Level8WrongNumber = 0;
		} else {
			Test2Level8WrongNumber = this.state.test2[(this.state.test2.length)-1].Test2Level8WrongNumber;
		}
  		Test2Attempts += 1;
    	if(this.state.isCorrect == "Correct") {
    		Test2TotalCorrect += 1;
    		Test2Level8WrongNumber = 0;
    		if(this.state.test2[(this.state.test2.length)-1].Test2Level8CorrectNumber == undefined) {
				Test2Level8CorrectNumber = 1;
			} else {
				console.log("here");
				Test2Level8CorrectNumber=(this.state.test2[(this.state.test2.length)-1].Test2Level8CorrectNumber) +1;
			}

			if((Test2Level8CorrectNumber % 3) == 0) {
				incompleteLevel = 9;
				Meteor.call('test2.Test2Level8Insert',Test2Level8CorrectNumber, Test2Level8WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
				setTimeout(() => history.push('/Test2Level9'), 0); //go forward here
			} else {
				incompleteLevel = 8;
				Meteor.call('test2.Test2Level8Insert',Test2Level8CorrectNumber, Test2Level8WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
    		...
    		Test2TotalWrong += 1;
    		Test2Level8CorrectNumber = 0;
    		if(this.state.test2[(this.state.test2.length)-1].Test2Level8WrongNumber == undefined) {
				Test2Level8WrongNumber = 1;
			} else {
				console.log("here");
				Test2Level8WrongNumber=(this.state.test2[(this.state.test2.length)-1].Test2Level8WrongNumber) +1;
			}

			if((Test2Level8WrongNumber % 3) == 0) {
				incompleteLevel = 7;
				Meteor.call('test2.Test2Level8Insert',Test2Level8CorrectNumber, Test2Level8WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
				setTimeout(() => history.push('/Test2Level7'), 0); //go back here
			} else {
				incompleteLevel = 8;
				Meteor.call('test2.Test2Level8Insert',Test2Level8CorrectNumber, Test2Level8WrongNumber, incompleteLevel, Test2Attempts, Test2TotalCorrect, Test2TotalWrong);
				setTimeout(() => window.location.reload(), 0);
  	...
  	render() {
  		...
  		if(this.state.test2[(this.state.test2.length)-1]) {
  			corno = this.state.test2[(this.state.test2.length)-1].Test2Level8CorrectNumber;
  			wrongno = this.state.test2[(this.state.test2.length)-1].Test2Level8WrongNumber;
  		} else {
  			corno = 0;
  			wrongno = 0;
  		}
				...
				<div>
					<div>
						<div className = "chartBox">
							<Test2Level8Graph array={this.state.graphArray}/>
						</div>
