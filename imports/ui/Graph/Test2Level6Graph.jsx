...
export default class Test2Level6Graph extends Component {
	...
	componentDidMount() {
		...
		biquadFilter.frequency.value = 25; //most important - change this to see if filter working properly - it is
		...
		biquadFilter2.frequency.value = 65; //most important - change this to see if filter working properly - it is
		...
		biquadFilter3.frequency.value = 190; //most important - change this to see if filter working properly - it is
		...
		biquadFilter4.frequency.value = 550; //most important - change this to see if filter working properly - it is
		...
		biquadFilter5.frequency.value = 1500; //most important - change this to see if filter working properly - it is
		...
		biquadFilter6.frequency.value = 4500; //most important - change this to see if filter working properly - it is
		...
		biquadFilter7.frequency.value = 11000; //most important - change this to see if filter working properly - it is
		...
		//DO THISSSSS!!!!!!!
		var peaks = [biquadFilter.frequency.value, biquadFilter2.frequency.value, biquadFilter3.frequency.value, biquadFilter4.frequency.value, biquadFilter5.frequency.value, biquadFilter6.frequency.value, biquadFilter7.frequency.value];
		...
		return (
			<div className = "chart">
				<div className = "chart__content">
					<h1 className = "chart__header">Level 6</h1>
