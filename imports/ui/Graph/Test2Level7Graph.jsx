...
export default class Test2Level7Graph extends Component {
	...
	componentDidMount() {
		...
		biquadFilter3.frequency.value = 125; //most important - change this to see if filter working properly - it is
		...
		biquadFilter5.frequency.value = 800; //most important - change this to see if filter working properly - it is
		...
		biquadFilter6.frequency.value = 2250; //most important - change this to see if filter working properly - it is
		...
		biquadFilter7.frequency.value = 5000; //most important - change this to see if filter working properly - it is
		...
		biquadFilter8.frequency.value = 10000; //most important - change this to see if filter working properly - it is
		...
		//DO THISSSSS!!!!!!!
		var peaks = [biquadFilter.frequency.value, biquadFilter2.frequency.value, biquadFilter3.frequency.value, biquadFilter4.frequency.value, biquadFilter5.frequency.value, biquadFilter6.frequency.value, biquadFilter7.frequency.value, biquadFilter8.frequency.value];
		...
		return (
			<div className = "chart">
				<div className = "chart__content">
					<h1 className = "chart__header">Level 7</h1>
