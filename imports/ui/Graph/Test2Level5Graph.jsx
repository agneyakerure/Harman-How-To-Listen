...
biquadFilter.frequency.value = 27; //most important - change this to see if filter working properly - it is
...
biquadFilter2.frequency.value = 100; //most important - change this to see if filter working properly - it is
...
biquadFilter3.frequency.value = 350; //most important - change this to see if filter working properly - it is
...
biquadFilter4.frequency.value = 1100; //most important - change this to see if filter working properly - it is
...
biquadFilter5.frequency.value = 3000; //most important - change this to see if filter working properly - it is
...
biquadFilter6.frequency.value = 9000; //most important - change this to see if filter working properly - it is
...
//DO THISSSSS!!!!!!!
var peaks = [biquadFilter.frequency.value, biquadFilter2.frequency.value, biquadFilter3.frequency.value, biquadFilter4.frequency.value, biquadFilter5.frequency.value, biquadFilter6.frequency.value];
...
export default class Test2Level5Graph extends Component {
