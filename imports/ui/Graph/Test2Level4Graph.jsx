...
export default class Test2Level4Graph extends Component {
	...
	componentDidMount() {
		...
		biquadFilter3.frequency.value = 900; //most important - change this to see if filter working properly - it is
		...
		biquadFilter4.frequency.value = 3000; //most important - change this to see if filter working properly - it is
		...
		biquadFilter5.frequency.value = 12000; //most important - change this to see if filter working properly - it is
		...
		//DO THISSSSS!!!!!!!
		var peaks = [biquadFilter.frequency.value, biquadFilter2.frequency.value, biquadFilter3.frequency.value, biquadFilter4.frequency.value, biquadFilter5.frequency.value];
	    ...
	    var magResponse5 = new Float32Array(width); //create new everytime you add a filter
		...
		return (
			<div className = "chart">
				<div className = "chart__content">
					<h1 className = "chart__header">Level 4</h1>
