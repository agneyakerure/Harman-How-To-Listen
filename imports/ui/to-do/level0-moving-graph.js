...
var k = 0;
export default class Test2Level0Graph extends Component {
	...
	createFilter(value) {
		...
		biquadFilter.frequency.value = value; //most important - change this to see if filter working properly - it is
		...
		var peaks = [biquadFilter.frequency.value]; 
		...
		return (
			<div className = "chart">
				<div className = "chart__content">
					...
					<svg id="chart" width="700" height="400" key={this.k} viewBox="0 0 700 400" preserveAspectRatio="xMidYMid meet"></svg>
				</div>
				<input type="range" step="0.5" value="20" ref="slider1" min="10" max="22050" className="Level1Slider1" value={this.state.firstSlider} onChange={this.handleFirstSlider.bind(this)}/>					
